...
async fn main(_spawner: embassy_executor::Spawner) {
    ...
    // SPI pinout for the Waveshare ESP32-C3 evaluation board (adjust to your wiring).
    ...
    println!("PMW3389 sample on Waveshare ESP32-C3 (esp-hal-embassy)");
...
// Minimal helper to reduce repetitive error handling without pulling in defmt on ESP targets.
